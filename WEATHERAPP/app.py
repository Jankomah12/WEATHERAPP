...
def get_crop_advice(crop, temp, condition, humidity, rain_chance):
    ...
    advice = {
        ...
        "Pepper (Chilli & Bell)": {
            "good": "🌶️ Good day for pepper! Check for pepper weevil and anthracnose.",
            "rain": "🌶️ Light rain good for pepper. Heavy rain causes flower and fruit drop.",
            "hot": "🌶️ Pepper tolerates heat! Chilli varieties especially heat tolerant.",
            "humid": "🌶️ Watch for phytophthora blight and cercospora leaf spot.",
            "cold": "🌶️ Pepper prefers warm conditions. Cold causes stunting."
        },
        "Onion": {
        ...
        "Chilli Pepper": {
            "good": "🌶️ Great day for chilli! Heat tolerant crop. Check for anthracnose.",
            "rain": "🌶️ Light rain good for chilli. Heavy rain causes anthracnose on fruits.",
            "hot": "🌶️ Chilli loves heat! One of Ghana's most heat tolerant crops.",
            "humid": "🌶️ Watch for phytophthora blight in humid conditions.",
            "cold": "🌶️ Chilli prefers warm conditions. Cold causes stunting."
        },
        "Cotton": {
...
def get_rain_alert(rain_chance):
    if rain_chance >= 80:
        ...
        return "🌧️ Good chance of rain today! Keep an umbrella handy!"
    elif rain_chance >= 40:
